...
--                                                                          --
--            T E S T _ D Y N A M I C _ P O O L S _ A D A 2 0 2 2           --
--                                                                          --
--                                B o d y                                   --
--                                                                          --
...
is
   ...
   is
      ...
      Name : constant String_Access := new String'("Depth=" & Depth'Image);
   ...
   begin
      ...
      Put_Line ("Storage Used=" & Pool.Storage_Used'Image &
...
begin --  Test_Dynamic_Pools_Ada2012
   ...
   begin
      ...
      Put_Line ("Storage Used in Default Subpool=" & Subpool_Storage_Used'Image
                & ", Storage Size=" &
   ...
   begin
      ...
      begin
         ...
         for I in 1 .. 10 loop
            ...
            begin
               Put_Line ("Object Value=" & Object.all'Image);
            end;
         end loop;
   ...
   begin
      ...
      Put_Line ("Id'Address=" & Id.all'Address'Image);
